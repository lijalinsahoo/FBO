...
//});$( "#sarticle" ).click(function()
	...
	$(document).ready(function()
		...
		var links = '<li><a href="cast_crew.html?'+a_id+'"><img src="images/icons/black/users.png" alt="" title="" /><span>Cast and Crew</span></a></li><li><a href="photos.html?'+a_id+'"><img src="images/icons/black/photos.png" alt="" title="" /><span>Photos</span></a></li><li><a href="trailer.html?'+a_id+'" ><img src="images/icons/black/video.png" alt="" title="" /><span>Videos</span></a></li><li><a href="music.html?'+a_id+'"><img src="images/icons/black/slider.png" alt="" title="" /><span>Music</span></a></li><li><a href="news.html?'+a_id+'"><img src="images/icons/black/blog.png" alt="" title="" /><span>Articles</span></a></li>  <li><a href="movie_review.html?'+a_id+'"><img src="images/icons/black/like.png" alt="" title="" /><span>Review</span></a></li><li><a href="movie-box-detail.html?'+a_id+'"><img src="images/icons/black/building.png" alt="" title="" /><span>Box Office</span></a></li>';
