	...
	$(document).ready(function()
		...
		$.getJSON(url,function(result){ //alert(url);
	        ...
	        $.each(result, function(i, field){
				...
				$("#comments").append('<li class="comment_row"><div class="comm_avatar"><img src="'+img_value+'" alt="" title="" border="0" /></div><div class="comm_content"><p>'+review_comment+' <a href="#">'+full_name+'</a></p></div></li>') ;
